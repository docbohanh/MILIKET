...
//    static var main: UIColor { return UIColor(rgba: "297FC8")  }//Màu xanh duong
    static var main: UIColor { return UIColor(rgba: "88B04B")  } //Màu xanh greenery
    
    struct Navigation {
        
        //                static var background = UIColor(rgba: "0086B8")
        static var background = UIColor(rgba: "297FC8")
        
        
        //         static var background = UIColor(rgba: "E05A20")
        ...
        /**
         Màu chính trong app
         */
        static var main = UIColor(rgba: "297FC8")    // Màu Xanh da trời 1D89E
        
        static var sub = UIColor(rgba: "FF783C")     // Màu đỏ FF783
    ...
    struct Background {
        static var headerView = UIColor.white.alpha(0.9)
        ...
        static var quickHelp = UIColor.black.alpha(0.65)
    ...
    struct Table {
        ...
        //        static var tableGroup = UIColor(red: 239 / 255.0, green: 239 / 255.0, blue: 244 / 255.0, alpha: 1.0)
    ...
    struct Text {
        ...
        // Màu điểm đi
        static var fromAddress = UIColor(rgba: "297FC8")
        
        
        
        // Màu điểm đến
        static var toAddress =  UIColor(rgba: "FF783C")
