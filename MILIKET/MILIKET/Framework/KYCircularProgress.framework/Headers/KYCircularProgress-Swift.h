...
/**
  Progress bar colors. You can set many colors in \code
  colors
  \endcode property, and it makes gradation color in \code
  colors
  \endcode.
*/
...
*/
@property (nonatomic, strong) UIColor * _Nonnull progressGuideColor;
/**
  Switch of progress guide view. If you set to \code
  true
  \endcode, progress guide view is enabled.
*/
...
/**
  Create \code
  KYCircularProgress
  \endcode with progress guide.
  \param frame \code
  KYCircularProgress
  \endcode frame.

  \param showProgressGuide If you set to \code
  true
  \endcode, progress guide view is enabled.
...
/**
  This closure is called when set value to \code
  progress
  \endcode property.
  \param completion progress changed closure.

*/
- (void)progressChangedClosure:(void (^ _Nonnull)(double, KYCircularProgress * _Nonnull))completion;
@end
